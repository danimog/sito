<template>
    <div class="container mx-auto my-10 p-3">
        <div class="text-5xl font-extrabold text-center">
            <span class="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-green-700">
                La mia storia
            </span>
        </div>
        ...
        <div class="text-5xl font-extrabold text-center">
            <span class="bg-clip-text text-transparent bg-gradient-to-r from-green-700 to-blue-600">
        ...
        <p class="my-5 lg:px-20 lg:text-xl">
            Il bene del nostro territorio, dove la <strong>sanità</strong>, il <strong>lavoro</strong>, le
            <strong>infrastrutture</strong>, il
            sostegno alle <strong>famiglia</strong>, le politiche per l’<strong>imprenditoria</strong> giovanile,
            l’attenzione
            agli <strong>anziani</strong> e non ultima la <strong>cura del nostro territorio</strong>, sono i valori al
            centro del
            ...
            Una <strong>provincia</strong> dove anche il suo <strong>capoluogo</strong> patisce <strong>l’impoverimento
                generale delle infrastrutture:</strong> il sovraffollamento dei <strong>treni</strong>, il rincaro degli
            <strong>affitti</strong>,
            l’incuria delle <strong>strade provinciali</strong> e, non ultima, una <strong>sanità</strong> pubblica e
            centrale
